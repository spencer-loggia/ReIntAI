...
if __name__=="__main__":
    ...
    if DISJOINT_CRITIC:
        ...
        path = "models/evo_7"
        agent = WaterworldAgent(num_nodes=4, spatial=7, channels=3, input_channels=2)
    ...
    # evo.load_model("/Users/loggiasr/Projects/ReIntAI/models/disjoint_evo_7/snap_2500_5.72_.pkl")
